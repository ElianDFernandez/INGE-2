...
from .views import (reserva_list, reserva_confirm, reserva_cancel, reservas_disponibles,inscripcion_confirm, inscripcion_cancel, pago_exitoso, pago_fallido, pagar_restante, simular_reembolso)
